...
**Simple Tweets** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://developer.twitter.com/en/docs/api-reference-index).
...
[Simple Tweets walkthrough (alpha version)](https://www.dropbox.com/s/k880xdptuz5mduq/SimpltTweets_adv_000.mp4?dl=0)

## Notes

Adapting the content of the video to my existing code from week 3 was pretty hard.
